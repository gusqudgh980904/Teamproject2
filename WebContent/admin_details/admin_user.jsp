...
function remove(){
	window.open("http://localhost/TeamProject2/common/login/popup/user_delete.jsp","remove","width=650,height=380px")
}//confirm
</script>
</head>
<body>
<div id="wrap">
	...
	<div id="container">
		...
		<div id="sidemenu">
			...
			<input type="button" value="탈퇴" class="btn btn-primary btn-lg" style="position:relative;left:1100px;top:50px" onclick="remove()"/>
