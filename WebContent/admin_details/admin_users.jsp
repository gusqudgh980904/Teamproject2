...
/* 상세정보 */
#detils{width:1200px;height:600px;position:relative;top:100px;left:350px}
</style>
...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="sidemenu">
			...
			<input type="button" value="탈퇴" class="btn btn-primary btn-lg" style="position:relative;left:1100px;top:130px;"/>
