...
td{width: 395px;height:415px;border:1px solid #dfdfdf; text-align: center;}
...
<body>
    ...
    <!-- container start -->
		...
		<div>
			...
			<table>
			<tr>
				<td onclick="location.href='http://211.63.89.147/team_prj2/product/guest_prod_detail.jsp'">1</td>
				<td>2</td>
				<td>3</td>
				<td>4</td>
			</tr>
